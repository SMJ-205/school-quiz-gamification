...
export default function QuestionPanel() {
  ...
  return (
    <>
      <div className="w-full max-w-4xl sm:max-w-5xl lg:max-w-5xl xl:max-w-6xl mx-auto flex flex-col gap-5 sm:gap-8 mt-4 sm:mt-6 md:mt-8 pt-4 sm:pt-8 md:pt-10 mb-auto">
