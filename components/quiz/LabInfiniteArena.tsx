    ...
    <div className="min-h-screen flex flex-col bg-[#050B14] select-none">
      ...
      {showGradeModal && (
        <div className="fixed inset-0 z-50 bg-black/90 backdrop-blur-md overflow-y-auto p-3 sm:p-6 md:p-8 select-none animate-fadeIn flex justify-center items-start sm:items-center">
          <div className="relative w-full max-w-3xl sm:max-w-4xl lg:max-w-5xl crt-arcade-frame bg-[#081320] border-4 border-cyan-400 rounded-3xl p-6 sm:p-10 md:p-14 text-stone-100 font-pixel text-center flex flex-col items-center my-4 sm:my-auto shadow-[0_0_60px_rgba(6,182,212,0.6)]">
