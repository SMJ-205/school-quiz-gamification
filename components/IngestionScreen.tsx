      ...
      <div className="relative z-10 w-full max-w-2xl">
        ...
        <div className="crt-arcade-frame mb-4 p-4 sm:p-5 text-center">
          ...
          <div
            key={shakeKey}
            {...getRootProps()}
            className={`border-3 border-dashed rounded-xl p-6 sm:p-8 pt-8 sm:pt-10 text-center cursor-pointer transition-all ${
              isDragActive
          ...
          >
            <input {...getInputProps()} />
            <div className="text-2xl sm:text-3xl mb-2.5 mt-3">
